...
![Version: 5.4.1](https://img.shields.io/badge/Version-5.4.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.117.0](https://img.shields.io/badge/AppVersion-2.117.0-informational?style=flat-square)
...
| broker.image | Pact Broker image url | string | `"ghcr.io/pact-foundation/pact-broker:2.136.0-pactbroker2.117.1"` |
